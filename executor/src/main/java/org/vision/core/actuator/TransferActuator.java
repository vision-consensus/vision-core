...
import static org.vision.core.config.Parameter.ChainConstant.TRANSFER_FEE;
...
public class TransferActuator extends AbstractActuator {
  ...
  public boolean validate() throws ContractValidateException {
    ...
    if (Arrays.equals(toAddress, ownerAddress)) {
      throw new ContractValidateException("Cannot transfer VS to yourself.");
    }
    ...
    try {
      ...
      //after ForbidTransferToContract proposal, send vs to smartContract by actuator is not allowed.
      if (dynamicStore.getForbidTransferToContract() == 1
          && toAccount != null
          && toAccount.getType() == AccountType.Contract) {

        throw new ContractValidateException("Cannot transfer VS to a smartContract.");
