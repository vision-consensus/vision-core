...
import org.vision.protos.Protocol.MarketOrderDetail;
...
public class MarketSellAssetActuator extends AbstractActuator {
  ...
  private void matchSingleOrder(MarketOrderCapsule takerOrderCapsule,
    ...
    // for makerPrice,sellToken is A,buyToken is VS.
    // for takerPrice,buyToken is A,sellToken is VS.

    // makerSellTokenQuantity_A/makerBuyTokenQuantity_VS =
    //   takerBuyTokenQuantityCurrent_A/takerSellTokenQuantityRemain_VS
    // => takerBuyTokenQuantityCurrent_A = takerSellTokenQuantityRemain_VS *
    //   makerSellTokenQuantity_A/makerBuyTokenQuantity_VS
    ...
    if (takerBuyTokenQuantityRemain == makerOrderCapsule.getSellTokenQuantityRemain()) {
      ...
      // makerSellTokenQuantityRemain_A/makerBuyTokenQuantityCurrent_VS =
      //   makerSellTokenQuantity_A/makerBuyTokenQuantity_VS
      // => makerBuyTokenQuantityCurrent_VS = makerSellTokenQuantityRemain_A *
      //   makerBuyTokenQuantity_VS / makerSellTokenQuantity_A
    ...
    addVsOrToken(takerOrderCapsule, takerBuyTokenQuantityReceive, takerAccountCapsule);
    addVsOrToken(makerOrderCapsule, makerBuyTokenQuantityReceive);
  ...
  // for taker
  private void addVsOrToken(MarketOrderCapsule orderCapsule, long num,
