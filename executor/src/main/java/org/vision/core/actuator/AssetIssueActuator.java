...
public class AssetIssueActuator extends AbstractActuator {
  ...
  public boolean execute(Object result) throws ContractExeException {
    ...
    try {
      ...
      if (dynamicStore.supportBlackHoleOptimization()) {
        ...
        Commons.adjustBalance(accountStore, accountStore.getSingularity(), fee);//send to blackhole
      }
  ...
  public boolean validate() throws ContractValidateException {
    ...
    if (dynamicStore.getAllowSameTokenName() != 0) {
      ...
      if (("vs").equals(name)) {
        throw new ContractValidateException("assetName can't be vs");
      }
    }
    ...
    if (assetIssueContract.getVsNum() <= 0) {
      throw new ContractValidateException("VsNum must greater than 0!");
    }
