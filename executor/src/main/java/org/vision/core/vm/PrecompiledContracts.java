...
import static org.vision.common.runtime.vm.DataWord.WORD_SIZE;
import static org.vision.common.utils.BIUtil.addSafely;
import static org.vision.common.utils.BIUtil.isLessThan;
import static org.vision.common.utils.BIUtil.isZero;
import static org.vision.common.utils.ByteUtil.EMPTY_BYTE_ARRAY;
import static org.vision.common.utils.ByteUtil.bytesToBigInteger;
import static org.vision.common.utils.ByteUtil.merge;
import static org.vision.common.utils.ByteUtil.numberOfLeadingZeros;
import static org.vision.common.utils.ByteUtil.parseBytes;
import static org.vision.common.utils.ByteUtil.parseWord;
...
import org.vision.common.crypto.SignatureInterface;
import org.vision.common.crypto.zksnark.BN128;
import org.vision.common.crypto.zksnark.BN128Fp;
import org.vision.common.crypto.zksnark.BN128G1;
import org.vision.common.crypto.zksnark.BN128G2;
import org.vision.common.crypto.zksnark.Fp;
import org.vision.common.crypto.zksnark.PairingCheck;
import org.vision.common.parameter.CommonParameter;
import org.vision.common.runtime.vm.DataWord;
import org.vision.common.utils.BIUtil;
...
public class PrecompiledContracts {
  ...
  public static PrecompiledContract getContractForAddress(DataWord address) {
    ...
    if (VMConfig.allowVvmSolidity059() && address.equals(batchValidateSignAddr)) {
      return batchValidateSign;
    }
    if (VMConfig.allowVvmSolidity059() && address.equals(validateMultiSignAddr)) {
      return validateMultiSign;
    }
    if (VMConfig.allowShieldedVRC20Transaction() && address.equals(verifyMintProofAddr)) {
      return verifyMintProof;
    }
    if (VMConfig.allowShieldedVRC20Transaction() && address.equals(verifyTransferProofAddr)) {
      return verifyTransferProof;
    }
    if (VMConfig.allowShieldedVRC20Transaction() && address.equals(verifyBurnProofAddr)) {
      return verifyBurnProof;
    }
    if (VMConfig.allowShieldedVRC20Transaction() && address.equals(merkleHashAddr)) {
      return merkleHash;
    }
  ...
  public static class ValidateMultiSign extends PrecompiledContract {
    ...
    public Pair<Boolean, byte[]> execute(byte[] rawData) {
      ...
      byte[] combine = ByteUtil
          .merge(TransactionTrace.convertToVisionAddress(addr), ByteArray.fromInt(permissionId), data);
      ...
      AccountCapsule account = this.getDeposit().getAccount(TransactionTrace.convertToVisionAddress(addr));
      if (account != null) {
        try {
