  ...
  public void doMaintenance() {
    ...
    if (!countWitness.isEmpty()) {
      ...
      countWitness.forEach((address, voteBuilder) -> {
        ...
        if (account.getSRGuaranteeFrozenBalance() > dynamicPropertiesStore.getSrFreezeLowest()) {
          maxVoteCounts = (long) ((account.getSRGuaranteeFrozenBalance() - dynamicPropertiesStore.getSrFreezeLowest())
