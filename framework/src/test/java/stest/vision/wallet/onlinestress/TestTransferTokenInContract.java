...
public class TestTransferTokenInContract {
  ...
  public void continueRun() {
    ...
    String abi = "[{\"constant\":false,\"inputs\":[{\"name\":\"toAddress\",\"type\":\"address\"},"
        + "{\"name\":\"id\",\"type\":\"vrcToken\"},{\"name\":\"amount\",\"type\":\"uint256\"}],"
    ...
    abi = "[{\"constant\":false,\"inputs\":[{\"name\":\"toAddress\",\"type\":\"address\"},"
        + "{\"name\":\"tokenId\",\"type\":\"vrcToken\"}],\"name\":\"getTokenBalnce\",\"outputs\":"
    ...
    for (int i = 0; i < 1000000000000L; i++) {
      ...
      triggerTxid = PublicMethed
          .triggerContract(tokenBalanceContractAddress, "getTokenBalnce(address,vrcToken)",
