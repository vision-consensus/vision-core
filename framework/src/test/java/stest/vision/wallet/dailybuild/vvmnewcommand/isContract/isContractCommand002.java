package stest.vision.wallet.dailybuild.vvmnewcommand.isContract;
...
public class isContractCommand002 {
  ...
  public void test01SelfdestructContract() {
    ...
    String filePath = "src/test/resources/soliditycode/VvmIsContract001.sol";
  ...
  public void test02NoConstructorContract() {
    Assert.assertTrue(PublicMethed
        .sendcoin(contractExcAddress, 10000000000L, testNetAccountAddress, testNetAccountKey,
            blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    String filePath = "src/test/resources/soliditycode/VvmIsContract002.sol";
    String contractName = "testIsContract";
    HashMap retMap = PublicMethed.getBycodeAbi(filePath, contractName);
    String code = retMap.get("byteCode").toString();
    String abi = retMap.get("abI").toString();
