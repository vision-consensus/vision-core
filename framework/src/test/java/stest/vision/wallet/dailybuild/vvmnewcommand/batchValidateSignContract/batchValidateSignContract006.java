...
public class batchValidateSignContract006 {
  ...
  public void test01HashIsEmpty() {
    ...
    Long photontUsed = infoById.get().getReceipt().getPhotonUsage();
    ...
    logger.info("fee:" + fee);
    logger.info("photontUsed:" + photontUsed);
    ...
    Assert.assertTrue(beforeFreePhotonUsed + photontUsed >= afterFreePhotonUsed);
    Assert.assertTrue(beforePhotonUsed + photontUsed >= afterPhotonUsed);
  }
