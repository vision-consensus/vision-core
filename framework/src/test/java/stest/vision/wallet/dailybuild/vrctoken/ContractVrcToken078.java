...
public class ContractVrcToken078 {
  ...
  public void testOriginCall001() {
    ...
    String filePath = "./src/test/resources/soliditycode/contractVrcToken078.sol";
    ...
    String filePath1 = "./src/test/resources/soliditycode/contractVrcToken078.sol";
    ...
    String filePath2 = "./src/test/resources/soliditycode/contractVrcToken078.sol";
    ...
    AccountResourceMessage resourceInfo1 = PublicMethed.getAccountResource(internalTxsAddress,
        blockingStubFull);
    logger.info("getEntropyUsed  " + resourceInfo1.getEntropyUsed());
    logger.info("getEntropyLimit  " + resourceInfo1.getEntropyLimit());
