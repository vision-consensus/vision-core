package stest.vision.wallet.dailybuild.assetissue.grammar;
...
import static org.vision.protos.Protocol.Transaction.Result.contractResult.STACK_TOO_LARGE_VALUE;
import static org.vision.protos.Protocol.Transaction.Result.contractResult.STACK_TOO_SMALL_VALUE;
...
public class ContractGrammar004 {
  ...
  public void test8Grammar008() {
    ...
    txid = PublicMethed
        .triggerContract(contractAddress, "testTransferVsNonexistentTarget(uint256,address)", num,
    ...
    /*Assert.assertEquals(
        "transfer vs failed: Validate InternalTransfer error, no ToAccount."
