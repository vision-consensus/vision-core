package org.vision.common.overlay.discover.node;
...
import org.vision.common.overlay.discover.node.statistics.MessageStatistics;
...
import org.vision.common.overlay.message.PongMessage;
...
public class NodeStatisticsTest {
  ...
  public void testMessage() {
    ...
    Assert.assertEquals(1, statistics.visionInSyncBlockChain.getTotalCount());
    ...
    Assert.assertEquals(1, statistics.visionOutBlockChainInventory.getTotalCount());
    ...
    Assert.assertEquals(1, statistics.visionInBlockInventory.getTotalCount());
    ...
    Assert.assertEquals(1, statistics.visionInTrxFetchInvData.getTotalCount());
    ...
    Assert.assertEquals(1, statistics.visionInTrxs.getTotalCount());
    ...
    long inBlockCount = statistics.visionInBlock.getTotalCount();
