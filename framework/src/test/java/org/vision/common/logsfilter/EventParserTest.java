...
public class EventParserTest {
  ...
  public synchronized void testEventParser() {
    ...
    String dataStr = "0x000000000000000000000000ca35b7d915458ef540ade6068dfe2f44e8fa733c000000000"
        ...
        + "000000000";
    ABI abi = VvmTestUtils.jsonStr2Abi(abiStr);
    ...
    Assert.assertEquals(dataMap.get("0"), "VV6QmkikJPPGyvYmEiAWSSQhsGoGFKFrLC");
    Assert.assertEquals(dataMap.get("addr"), "VV6QmkikJPPGyvYmEiAWSSQhsGoGFKFrLC");
