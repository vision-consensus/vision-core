package org.vision.common.logsfilter;
...
import org.vision.common.logsfilter.capsule.ContractEventTriggerCapsule;
...
public class FilterQueryTest {
  ...
  public synchronized void testParseFilterQueryBlockNumber() {
    {
      String blockNum = "";
      Assert.assertEquals(FilterQuery.LATEST_BLOCK_NUM, FilterQuery.parseToBlockNumber(blockNum));
    }

    {
      String blockNum = "earliest";
      Assert.assertEquals(FilterQuery.EARLIEST_BLOCK_NUM, FilterQuery.parseFromBlockNumber(blockNum));
    }
