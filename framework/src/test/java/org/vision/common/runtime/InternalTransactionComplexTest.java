...
public class InternalTransactionComplexTest {
   ...
   *
   * // this is to test wither the VVM is returning vars from one contract calling another //
  ...
  public void internalTransactionAsInstanceTest()
    ...
    /* =================================== CALL makeTheCall =================================== */
    byte[] triggerData1 = VvmTestUtils.parseAbi("makeTheCall()", "");
    ...
    byte[] triggerData2 = VvmTestUtils.parseAbi("testCallbackReturns_()", "");
    runtime = VvmTestUtils
        .triggerContractWholeProcessReturnContractAddress(Hex.decode(OWNER_ADDRESS),
