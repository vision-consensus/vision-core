...
public class PrecompiledContractsVerifyProofTest {
  ...
  public void verifyMintProofCorrect() throws ZksnarkException {
    ...
    for (int countNum = 0; countNum < totalCountNum; countNum++) {
      ...
      builder.setShieldedVRC20Address(SHIELDED_CONTRACT_ADDRESS);
      ...
      ShieldedVRC20Parameters params = builder.build(false);
  ...
  public void verifyTransferProofCorrect() throws ZksnarkException {
    ...
    for (int countNum = 0; countNum < totalCountNum; countNum++) {
      ...
      { //for mint1
        ShieldedVRC20ParametersBuilder mintBuilder1 = new ShieldedVRC20ParametersBuilder();
        mintBuilder1.setTransparentFromAmount(BigInteger.valueOf(30));
        mintBuilder1.setShieldedVRC20Address(SHIELDED_CONTRACT_ADDRESS);
        mintBuilder1.setShieldedVRC20ParametersType(ShieldedVRC20ParametersBuilder.ShieldedVRC20ParametersType.MINT);
        mintBuilder1.addOutput(DEFAULT_OVK, senderPaymentAddress1.getD(),
            senderPaymentAddress1.getPkD(), 30, rcm1, new byte[512]);
        ShieldedVRC20Parameters mintParams1 = mintBuilder1.build(false);
      ...
      { //for mint2
        ShieldedVRC20ParametersBuilder mintBuilder2 = new ShieldedVRC20ParametersBuilder();
        mintBuilder2.setTransparentFromAmount(BigInteger.valueOf(70));
        mintBuilder2.setShieldedVRC20Address(SHIELDED_CONTRACT_ADDRESS);
        mintBuilder2.setShieldedVRC20ParametersType(ShieldedVRC20ParametersBuilder.ShieldedVRC20ParametersType.MINT);
        mintBuilder2.addOutput(DEFAULT_OVK, senderPaymentAddress2.getD(),
            senderPaymentAddress2.getPkD(), 70, rcm2, new byte[512]);
        ShieldedVRC20Parameters mintParams2 = mintBuilder2.build(false);
      ...
      { //for transfer
        ...
        ShieldedVRC20Parameters params = builder.build(true);
  ...
  public void verifyBurnProofCorrect() throws ZksnarkException {
    ...
    for (int countNum = 0; countNum < totalCountNum; countNum++) {
      ...
      { //for mint
        ShieldedVRC20ParametersBuilder mintBuilder = new ShieldedVRC20ParametersBuilder();
        mintBuilder.setTransparentFromAmount(BigInteger.valueOf(value));
        mintBuilder.setShieldedVRC20Address(SHIELDED_CONTRACT_ADDRESS);
        mintBuilder.setShieldedVRC20ParametersType(ShieldedVRC20ParametersBuilder.ShieldedVRC20ParametersType.MINT);
        mintBuilder.addOutput(DEFAULT_OVK, senderPaymentAddress.getD(),
            senderPaymentAddress.getPkD(), value, rcm, new byte[512]);
        ShieldedVRC20Parameters mintParams = mintBuilder.build(false);
  ...
  private byte[] abiEncodeForMintWrongCM(ShieldedVRC20Parameters params, long value,
      byte[] frontier, long leafCount) {
    byte[] mergedBytes;
    ShieldContract.ReceiveDescription revDesc = params.getReceiveDescription(0);
    mergedBytes = ByteUtil.merge(
  ...
  private byte[] abiEncodeForMintWrongCV(ShieldedVRC20Parameters params, long value,
      byte[] frontier, long leafCount) {
    byte[] mergedBytes;
    ShieldContract.ReceiveDescription revDesc = params.getReceiveDescription(0);
    mergedBytes = ByteUtil.merge(
  ...
  private byte[] abiEncodeForMintWrongEpk(ShieldedVRC20Parameters params, long value,
      byte[] frontier, long leafCount) {
    byte[] mergedBytes;
    ShieldContract.ReceiveDescription revDesc = params.getReceiveDescription(0);
    mergedBytes = ByteUtil.merge(
  ...
  private byte[] abiEncodeForMintWrongProof(ShieldedVRC20Parameters params, long value,
      byte[] frontier, long leafCount) {
    byte[] mergedBytes;
    ShieldContract.ReceiveDescription revDesc = params.getReceiveDescription(0);
    mergedBytes = ByteUtil.merge(
  ...
  private byte[] abiEncodeForMintWrongBindingSignature(ShieldedVRC20Parameters params, long value,
      byte[] frontier, long leafCount) {
    byte[] mergedBytes;
    ShieldContract.ReceiveDescription revDesc = params.getReceiveDescription(0);
    mergedBytes = ByteUtil.merge(
  ...
  private byte[] abiEncodeForMintWrongHash(ShieldedVRC20Parameters params, long value,
      byte[] frontier, long leafCount) {
    byte[] mergedBytes;
    ShieldContract.ReceiveDescription revDesc = params.getReceiveDescription(0);
    mergedBytes = ByteUtil.merge(
  ...
  private byte[] abiEncodeForTransferWrongNf(ShieldedVRC20Parameters params, byte[] frontier,
      long leafCount) {
    byte[] input = new byte[0];
    byte[] spendAuthSig = new byte[0];
    byte[] output = new byte[0];
  ...
  private byte[] abiEncodeForTransferWrongRoot(ShieldedVRC20Parameters params, byte[] frontier,
      long leafCount) {
    byte[] input = new byte[0];
    byte[] spendAuthSig = new byte[0];
    byte[] output = new byte[0];
  ...
  private byte[] abiEncodeForTransferWrongSpendCV(ShieldedVRC20Parameters params, byte[] frontier,
      long leafCount) {
    byte[] input = new byte[0];
    byte[] spendAuthSig = new byte[0];
    byte[] output = new byte[0];
  ...
  private byte[] abiEncodeForTransferWrongRk(ShieldedVRC20Parameters params, byte[] frontier,
      long leafCount) {
    byte[] input = new byte[0];
    byte[] spendAuthSig = new byte[0];
    byte[] output = new byte[0];
  ...
  private byte[] abiEncodeForTransferWrongSpendProof(ShieldedVRC20Parameters params,
      byte[] frontier,
      long leafCount) {
    byte[] input = new byte[0];
    byte[] spendAuthSig = new byte[0];
  ...
  private byte[] abiEncodeForTransferWrongCM(ShieldedVRC20Parameters params, byte[] frontier,
      long leafCount) {
    byte[] input = new byte[0];
    byte[] spendAuthSig = new byte[0];
    byte[] output = new byte[0];
  ...
  private byte[] abiEncodeForTransferWrongReceiveCV(ShieldedVRC20Parameters params, byte[] frontier,
      long leafCount) {
    byte[] input = new byte[0];
    byte[] spendAuthSig = new byte[0];
    byte[] output = new byte[0];
  ...
  private byte[] abiEncodeForTransferWrongEpk(ShieldedVRC20Parameters params, byte[] frontier,
      long leafCount) {
    byte[] input = new byte[0];
    byte[] spendAuthSig = new byte[0];
    byte[] output = new byte[0];
  ...
  private byte[] abiEncodeForTransferWrongReceivProof(ShieldedVRC20Parameters params,
      byte[] frontier,
      long leafCount) {
    byte[] input = new byte[0];
    byte[] spendAuthSig = new byte[0];
  ...
  private byte[] abiEncodeForTransferWrongBindingSignature(ShieldedVRC20Parameters params,
      byte[] frontier,
      long leafCount) {
    byte[] input = new byte[0];
    byte[] spendAuthSig = new byte[0];
  ...
  private byte[] abiEncodeForTransferWrongHash(ShieldedVRC20Parameters params, byte[] frontier,
      long leafCount) {
    byte[] input = new byte[0];
    byte[] spendAuthSig = new byte[0];
    byte[] output = new byte[0];
  ...
  private byte[] abiEncodeForBurnWrongNF(ShieldedVRC20Parameters params, long value) {
    byte[] mergedBytes;
    ShieldContract.SpendDescription spendDesc = params.getSpendDescription(0);
    mergedBytes = ByteUtil.merge(
        Wallet.generateRandomBytes(32),
  ...
  private byte[] abiEncodeForBurnWrongRoot(ShieldedVRC20Parameters params, long value) {
    byte[] mergedBytes;
    ShieldContract.SpendDescription spendDesc = params.getSpendDescription(0);
    mergedBytes = ByteUtil.merge(
        spendDesc.getNullifier().toByteArray(),
  ...
  private byte[] abiEncodeForBurnWrongCV(ShieldedVRC20Parameters params, long value) {
    byte[] mergedBytes;
    ShieldContract.SpendDescription spendDesc = params.getSpendDescription(0);
    mergedBytes = ByteUtil.merge(
        spendDesc.getNullifier().toByteArray(),
  ...
  private byte[] abiEncodeForBurnWrongRK(ShieldedVRC20Parameters params, long value) {
    byte[] mergedBytes;
    ShieldContract.SpendDescription spendDesc = params.getSpendDescription(0);
    mergedBytes = ByteUtil.merge(
        spendDesc.getNullifier().toByteArray(),
  ...
  private byte[] abiEncodeForBurnWrongProof(ShieldedVRC20Parameters params, long value) {
    byte[] mergedBytes;
    ShieldContract.SpendDescription spendDesc = params.getSpendDescription(0);
    mergedBytes = ByteUtil.merge(
        spendDesc.getNullifier().toByteArray(),
  ...
  private byte[] abiEncodeForBurnWrongAuthoritySignature(ShieldedVRC20Parameters params,
      long value) {
    byte[] mergedBytes;
    ShieldContract.SpendDescription spendDesc = params.getSpendDescription(0);
    mergedBytes = ByteUtil.merge(
  ...
  private byte[] abiEncodeForBurnWrongBingSignature(ShieldedVRC20Parameters params, long value) {
    byte[] mergedBytes;
    ShieldContract.SpendDescription spendDesc = params.getSpendDescription(0);
    mergedBytes = ByteUtil.merge(
        spendDesc.getNullifier().toByteArray(),
  ...
  private byte[] abiEncodeForBurnWrongHash(ShieldedVRC20Parameters params, long value) {
    byte[] mergedBytes;
    ShieldContract.SpendDescription spendDesc = params.getSpendDescription(0);
    mergedBytes = ByteUtil.merge(
        spendDesc.getNullifier().toByteArray(),
