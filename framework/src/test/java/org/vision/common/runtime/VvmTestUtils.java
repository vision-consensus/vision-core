...
public class VvmTestUtils {
  ...
  /**
   * use given input Transaction,deposit,block and execute VVM  (for both Deploy and Trigger
   * contracts).
   */
  ...
  public static VVMTestResult deployContractAndReturnVvmTestResult(String contractName,
                                                                   byte[] callerAddress,
                                                                   String abi, String code, long value, long feeLimit, long consumeUserResourcePercent,
    ...
    return processTransactionAndReturnVvmTestResult(trx, dbManager, blockCap)
  ...
  public static VVMTestResult triggerContractAndReturnVvmTestResult(byte[] callerAddress,
  ...
  public static VVMTestResult processTransactionAndReturnVvmTestResult(Transaction trx,
    ...
    trace.setResult();
    return new VVMTestResult(trace.getRuntime(), trace.getReceipt(), null);
  }
