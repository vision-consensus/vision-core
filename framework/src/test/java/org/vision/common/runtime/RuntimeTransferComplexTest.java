...
public class RuntimeTransferComplexTest {
  ...
  public void TransferTrxToContractAccountWhenDeployAContract()
    ...
    runtime = VvmTestUtils.processTransactionAndReturnRuntime(trx, deposit, null);
  ...
  public void TransferTrxToContractAccountWhenTriggerAContract()
    ...
    runtime = VvmTestUtils.processTransactionAndReturnRuntime(transaction, deposit, null);
    Assert.assertNull(runtime.getRuntimeError());
  ...
  public void TransferCallValueTestWhenUsingCallAndCreate()
    ...
    String params1 =
        "000000000000000000000000548794500882809695a8a687866e76d4271a1abc"; //TRANSFER_TO
    byte[] triggerData1 = VvmTestUtils.parseAbi(selectorStr1, params1);

    Transaction transaction1 = VvmTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData1, triggerCallValue, feeLimit);
    runtime = VvmTestUtils.processTransactionAndReturnRuntime(transaction1, deposit, null);
    Assert.assertNull(runtime.getRuntimeError());
    ...
    Assert.assertEquals(dbManager.getAccountStore().get(calledAddress).getBalance(),
        1000 - 5);  //Transfer 5 vdt to TransferTo
    Assert.assertEquals(dbManager.getAccountStore().get(Hex.decode(TRANSFER_TO)).getBalance(),
        transferToInitBalance + 5); // get 5 vdt from calledAddress
    recoverDeposit();
    ...
    String params2 =
        "000000000000000000000000548794500882809695a8a687866e76d4271a1abc"; //TRANSFER_TO
    byte[] triggerData2 = VvmTestUtils.parseAbi(selectorStr2, params2);

    Transaction transaction2 = VvmTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData2, triggerCallValue, feeLimit);
    runtime = VvmTestUtils.processTransactionAndReturnRuntime(transaction2, deposit, null);
    ...
    String params3 =
        "000000000000000000000000548794500882809695a8a687866e76d4271a1abc"; //TRANSFER_TO
    byte[] triggerData3 = VvmTestUtils.parseAbi(selectorStr3, params3);

    Transaction transaction3 = VvmTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData3, triggerCallValue, feeLimit);
    runtime = VvmTestUtils.processTransactionAndReturnRuntime(transaction3, deposit, null);
    ...
    String params4 =
        "000000000000000000000000548794500882809695a8a687866e76d4271a1abc"; //TRANSFER_TO
    byte[] triggerData4 = VvmTestUtils.parseAbi(selectorStr4, params4);

    Transaction transaction4 = VvmTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData4, triggerCallValue, feeLimit);
    runtime = VvmTestUtils.processTransactionAndReturnRuntime(transaction4, deposit, null);
    byte[] createdAddress = TransactionTrace.convertToVisionAddress(
    ...
    String params5 =
        "000000000000000000000000548794500882809695a8a687866e76d4271a1abc"; //TRANSFER_TO
    byte[] triggerData5 = VvmTestUtils.parseAbi(selectorStr5, params5);

    Transaction transaction5 = VvmTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData5, triggerCallValue, feeLimit);
    runtime = VvmTestUtils.processTransactionAndReturnRuntime(transaction5, deposit, null);
    byte[] createdAddress2 = TransactionTrace.convertToVisionAddress(
        new DataWord(runtime.getResult().getHReturn()).getLast20Bytes());
    ...
    String params6 =
        "000000000000000000000000548794500882809695a8a687866e76d4271a1abc"; //TRANSFER_TO
    byte[] triggerData6 = VvmTestUtils.parseAbi(selectorStr6, params6);

    Transaction transaction6 = VvmTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData6, triggerCallValue, feeLimit);
    runtime = VvmTestUtils.processTransactionAndReturnRuntime(transaction6, deposit, null);
    byte[] createdAddress3 = TransactionTrace.convertToVisionAddress(
        new DataWord(runtime.getResult().getHReturn()).getLast20Bytes());
    Assert.assertTrue(Hex.toHexString(new DataWord(createdAddress2).getLast20Bytes())
        .equalsIgnoreCase("0000000000000000000000000000000000000000"));
    Assert.assertTrue(runtime.getRuntimeError().contains("Invalid operation code: opCode[fe];"));
