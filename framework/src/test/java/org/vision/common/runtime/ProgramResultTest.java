...
import static org.vision.core.utils.TransactionUtil.generateContractAddress;
...
public class ProgramResultTest {
  ...
  public void uniqueInternalTransactionHashTest()
    ...
    /* =================================== CALL create() =================================== */
    byte[] triggerData1 = VvmTestUtils.parseAbi("create()", "");
    runtime = VvmTestUtils
  ...
  public void successAndFailResultTest()
    ...
    // ======================================= Test Success =======================================
    byte[] triggerData1 = VvmTestUtils.parseAbi("transfer(address,bool)", params);
    Transaction trx1 = VvmTestUtils
        .generateTriggerSmartContractAndGetTransaction(Hex.decode(OWNER_ADDRESS), aContract,
            triggerData1, 0, 100000000);
    TransactionTrace traceSuccess = VvmTestUtils
    ...
    byte[] triggerData2 = VvmTestUtils.parseAbi("transfer(address,bool)", params);
    Transaction trx2 = VvmTestUtils
        .generateTriggerSmartContractAndGetTransaction(Hex.decode(OWNER_ADDRESS), aContract,
            triggerData2, 0, 100000000);
    TransactionTrace traceFailed = VvmTestUtils
        .processTransactionAndReturnTrace(trx2, deposit, null);
    runtime = traceFailed.getRuntime();

    byte[] bContract2 =
        TransactionUtil.generateContractAddress(new TransactionCapsule(trx2).getTransactionId().getBytes(), 0);
  ...
  public void suicideResultTest()
    ...
    // ======================================= Test Suicide =======================================
    byte[] triggerData1 = VvmTestUtils.parseAbi("suicide(address)", params);
    Transaction trx = VvmTestUtils
        .generateTriggerSmartContractAndGetTransaction(Hex.decode(OWNER_ADDRESS), suicideContract,
            triggerData1, 0, 100000000);
    TransactionTrace trace = VvmTestUtils.processTransactionAndReturnTrace(trx, deposit, null);
  ...
  public void checkTransactionInfo(TransactionTrace trace, Transaction trx, BlockCapsule block,
    ...
    TransactionInfoCapsule trxInfoCapsule =
        org.vision.core.capsule.utils.TransactionUtil.buildTransactionInfoInstance(new TransactionCapsule(trx), null, trace);
