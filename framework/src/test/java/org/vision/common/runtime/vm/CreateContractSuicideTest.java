...
contract D {
  ...
  public void testAAfterAllowMultiSignProposal()
    ...
    this.manager.getDynamicPropertiesStore().saveAllowVvmTransferVrc10(1);
    ...
    Transaction cTrx = VvmTestUtils.generateDeploySmartContractAndGetTransaction(
