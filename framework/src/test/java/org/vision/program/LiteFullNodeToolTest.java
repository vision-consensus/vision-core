...
import org.vision.tool.litefullnode.LiteFullNodeTool;
...
public class LiteFullNodeToolTest {
  ...
  private void generateSomeTransactions(int during) {
    ...
    while (true) {
      ...
      String vdtPri = "cba92a516ea09f620a16ff7ee95ce0df1d56550a8babe9964981a7144c8a784a";
      byte[] vdtAddress = getFinalAddress(vdtPri);
      sendcoin(address, 1L,
              vdtAddress, vdtPri, blockingStubFull);
      try {
  ...
  public static byte[] getFinalAddress(String priKey) {
    Wallet.setAddressPreFixByte((byte) 0x46);
