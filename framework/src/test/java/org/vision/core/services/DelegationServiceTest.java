...
import static stest.vision.wallet.common.client.Parameter.CommonConstant.ADD_PRE_FIX_BYTE_MAINNET;
...
import org.vision.api.WalletGrpc.WalletBlockingStub;
...
public class DelegationServiceTest {
  ...
  public DelegationServiceTest(VisionApplicationContext context) {
  ...
  public static void testGrpc() {
    ...
    updateBrokerageContract.setOwnerAddress(
        ByteString.copyFrom(Commons.decodeFromBase58Check("TN3zfjYUmMFK3ZsHSsrdJoNRtGkQmZLBLz")))
        .setBrokerage(10);
  ...
  private void testPay(int cycle) {
    ...
    byte[] sr1 = Commons.decodeFromBase58Check("TLTDZBcPoJ8tZ6TTEeEqEvwYFk2wgotSfD");
  ...
  private void testWithdraw() {
    ...
    testPay(2);
    byte[] sr1 = Commons.decodeFromBase58Check("THKJYuUmMKKARNf7s2VT51g5uPY6KEqnat");
    AccountCapsule accountCapsule = manager.getAccountStore().get(sr1);
    byte[] sr27 = Commons.decodeFromBase58Check("TLTDZBcPoJ8tZ6TTEeEqEvwYFk2wgotSfD");
