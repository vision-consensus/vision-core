...
import org.vision.core.db2.SnapshotRootTest.ProtoCapsuleTest;
...
public class RevokingDbWithCacheNewValueTest {
  ...
  private TestRevokingVisionStore visionDatabase;
  ...
  public synchronized void testPop() throws RevokingStoreIllegalStateException {
    ...
    visionDatabase = new TestRevokingVisionStore("testRevokingDBWithCacheNewValue-testPop");
  ...
  public synchronized void testMerge() {
    revokingDatabase = context.getBean(SnapshotManager.class);
    revokingDatabase.enable();
    visionDatabase = new TestRevokingVisionStore("testRevokingDBWithCacheNewValue-testMerge");
    revokingDatabase.add(visionDatabase.getRevokingDB());
    ...
    try (ISession tmpSession = revokingDatabase.buildSession()) {
      visionDatabase.put(testProtoCapsule.getData(), testProtoCapsule2);
      tmpSession.merge();
    }
    Assert.assertEquals(testProtoCapsule2, visionDatabase.get(testProtoCapsule.getData()));

    try (ISession tmpSession = revokingDatabase.buildSession()) {
      visionDatabase.delete(testProtoCapsule.getData());
      tmpSession.merge();
    }
    Assert.assertNull(visionDatabase.get(testProtoCapsule.getData()));
    dialog.reset();
  }
  ...
  public synchronized void testRevoke() {
    revokingDatabase = context.getBean(SnapshotManager.class);
    revokingDatabase.enable();
    visionDatabase = new TestRevokingVisionStore("testRevokingDBWithCacheNewValue-testRevoke");
    revokingDatabase.add(visionDatabase.getRevokingDB());
    ...
    try (ISession tmpSession = revokingDatabase.buildSession()) {
      visionDatabase.put(testProtoCapsule.getData(), new ProtoCapsuleTest("revoke22".getBytes()));
      tmpSession.merge();
    }

    try (ISession tmpSession = revokingDatabase.buildSession()) {
      visionDatabase.put(testProtoCapsule.getData(), new ProtoCapsuleTest("revoke222".getBytes()));
      tmpSession.merge();
    }
    ...
    logger.info(
        "**********testProtoCapsule:" + (visionDatabase.getUnchecked(testProtoCapsule.getData()))
            .toString());
    Assert.assertEquals(testProtoCapsule, visionDatabase.get(testProtoCapsule.getData()));
  }
  ...
  public synchronized void testGetlatestValues() {
    revokingDatabase = context.getBean(SnapshotManager.class);
    revokingDatabase.enable();
    visionDatabase = new TestRevokingVisionStore("testSnapshotManager-testGetlatestValues");
    revokingDatabase.add(visionDatabase.getRevokingDB());
    while (revokingDatabase.size() != 0) {
      revokingDatabase.pop();
    }
    ...
    Set<ProtoCapsuleTest> result = visionDatabase.getRevokingDB().getlatestValues(5).stream()
  ...
  public synchronized void testGetValuesNext() {
    revokingDatabase = context.getBean(SnapshotManager.class);
    revokingDatabase.enable();
    visionDatabase = new TestRevokingVisionStore("testSnapshotManager-testGetValuesNext");
    revokingDatabase.add(visionDatabase.getRevokingDB());
    while (revokingDatabase.size() != 0) {
      revokingDatabase.pop();
    }
  ...
  public synchronized void testGetKeysNext() {
    revokingDatabase = context.getBean(SnapshotManager.class);
    revokingDatabase.enable();
    visionDatabase = new TestRevokingVisionStore("testSnapshotManager-testGetKeysNext");
    revokingDatabase.add(visionDatabase.getRevokingDB());
    while (revokingDatabase.size() != 0) {
      revokingDatabase.pop();
    }
    ...
    try (ISession tmpSession = revokingDatabase.buildSession()) {
      visionDatabase.put(pairPriceKey2, testProtoCapsule);
      tmpSession.commit();
    }
    testProtoCapsule = new ProtoCapsuleTest(("getKeysNext1").getBytes());
    try (ISession tmpSession = revokingDatabase.buildSession()) {
      visionDatabase.put(pairPriceKey1, testProtoCapsule);
      tmpSession.commit();
    }

    testProtoCapsule = new ProtoCapsuleTest(("getKeysNext0").getBytes());
    try (ISession tmpSession = revokingDatabase.buildSession()) {
      visionDatabase.put(pairPriceKey0, testProtoCapsule);
      tmpSession.commit();
    }
    testProtoCapsule = new ProtoCapsuleTest(("getKeysNext3").getBytes());
    try (ISession tmpSession = revokingDatabase.buildSession()) {
      visionDatabase.put(pairPriceKey3, testProtoCapsule);
      tmpSession.commit();
    }

    List<byte[]> result = visionDatabase.getRevokingDB().getKeysNext(pairPriceKey0, 4);
  ...
  public synchronized void testGetKeysNextWithSameKey() {
    revokingDatabase = context.getBean(SnapshotManager.class);
    revokingDatabase.enable();
    visionDatabase = new TestRevokingVisionStore("testSnapshotManager-testGetKeysNextWithSameKey");
    revokingDatabase.add(visionDatabase.getRevokingDB());
    while (revokingDatabase.size() != 0) {
      revokingDatabase.pop();
    }
    ...
    try (ISession tmpSession = revokingDatabase.buildSession()) {
      visionDatabase.put(pairPriceKey2, testProtoCapsule2);
      tmpSession.commit();
    }
    ...
    try (ISession tmpSession = revokingDatabase.buildSession()) {
      visionDatabase.put(pairPriceKey1, testProtoCapsule1);
      tmpSession.commit();
    }
    ...
    try (ISession tmpSession = revokingDatabase.buildSession()) {
      visionDatabase.put(pairPriceKey0, testProtoCapsule0);
      tmpSession.commit();
    }

    ProtoCapsuleTest testProtoCapsule3 = new ProtoCapsuleTest(("getKeysNext3").getBytes());
    try (ISession tmpSession = revokingDatabase.buildSession()) {
      visionDatabase.put(pairPriceKey3, testProtoCapsule3);
      tmpSession.commit();
    }

    List<byte[]> result = visionDatabase.getRevokingDB().getKeysNext(pairPriceKey0, 3);
  ...
  public static class TestRevokingVisionStore extends VisionStoreWithRevoking<ProtoCapsuleTest> {

    protected TestRevokingVisionStore(String dbName) {
      super(dbName);
    }
