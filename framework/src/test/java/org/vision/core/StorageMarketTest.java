...
import org.vision.core.db.StorageMarket;
...
public class StorageMarketTest {
  ...
  public void testBuyStorage() {
    ...
    long quant = 2_000_000_000_000L; // 2 million vs
  ...
  public void testBuyStorage2() {
    ...
    long quant = 1_000_000_000_000L; // 1 million vs
  ...
  public void testBuyStorageBytes() {
    ...
    long bytes = 2694881440L; // 2 million vs
  ...
  public void testSellStorage2() {
    ...
    long bytes1 = 2694881440L - 1360781717L; // 1 million vs
    long bytes2 = 1360781717L; // 1 million vs
