...
public class TransferAssetActuatorTest {
  ...
  private static final String ownerASSET_NAME = "vstest";
  ...
  /**
   * transfer assert to smartcontract addresss after VvmSolidity059
   */
  @Test
  public void transferToContractAddress()
    ...
    VMConfig.initAllowVvmTransferVrc10(1);
    VMConfig.initAllowVvmConstantinople(1);
    VMConfig.initAllowVvmSolidity059(1);
    String contractName = "testContract";
    byte[] address = Hex.decode(OWNER_ADDRESS);
    Commons.adjustBalance(dbManager.getChainBaseManager().getAccountStore(), address, 1000000000L);
