...
public class AssetIssueActuatorTest {
  ...
  private static final int VS_NUM = 10000;
  private static final int NUM = 100000;
  private static final String DESCRIPTION = "myCoin";
  private static final String URL = "vision-my.com";
  ...
  private Any getContract() {
    ...
    return Any.pack(
        AssetIssueContract.newBuilder()
            ...
            .setName(ByteString.copyFromUtf8(NAME)).setTotalSupply(TOTAL_SUPPLY).setVsNum(VS_NUM)
            .setNum(NUM)
  ...
  public void SameTokenNameCloseAssetIssueSuccess() {
    ...
    Long blackholeBalance = dbManager.getAccountStore().getSingularity().getBalance();
    try {
      actuator.validate();
      ...
      Assert.assertEquals(dbManager.getAccountStore().getSingularity().getBalance(),
      ...
      Assert.assertEquals(VS_NUM, assetIssueCapsule.getVsNum());
      ...
      Assert.assertEquals(VS_NUM, assetIssueCapsuleV2.getVsNum());
  ...
  public void negativeTotalSupplyTest() {
    ...
    try {
      ...
      Assert.assertEquals(owner.getBalance(),
          dbManager.getDynamicPropertiesStore().getAssetIssueFee());
      Assert
          .assertEquals(dbManager.getAccountStore().getSingularity().getBalance(), blackholeBalance);
  ...
  public void zeroTotalSupplyTest() {
    ...
    Any contract = Any.pack(
        AssetIssueContract.newBuilder()
            .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(OWNER_ADDRESS)))
            .setName(ByteString.copyFromUtf8(NAME)).setTotalSupply(0).setVsNum(VS_NUM).setNum(NUM)
            .setStartTime(nowTime).setEndTime(nowTime + 24 * 3600 * 1000)
            .setDescription(ByteString.copyFromUtf8(DESCRIPTION))
            .setUrl(ByteString.copyFromUtf8(URL)).build());
  ...
  public void negativeVsNumTest() {
    ...
    try {
      ...
      Assert.assertTrue(e instanceof ContractValidateException);
      Assert.assertTrue("VsNum must greater than 0!".equals(e.getMessage()));
      AccountCapsule owner = dbManager.getAccountStore()
          .get(ByteArray.fromHexString(OWNER_ADDRESS));
      AssetIssueCapsule assetIssueCapsule = dbManager.getAssetIssueStore()
          .get(ByteArray.fromString(NAME));
   ...
   * change.
   */
  public void zeroVsNumTest() {
    long nowTime = new Date().getTime();
    Any contract = Any.pack(
        AssetIssueContract.newBuilder()
            .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(OWNER_ADDRESS)))
            .setName(ByteString.copyFromUtf8(NAME)).setTotalSupply(TOTAL_SUPPLY).setVsNum(0)
            .setNum(NUM)
            .setStartTime(nowTime).setEndTime(nowTime + 24 * 3600 * 1000)
            .setDescription(ByteString.copyFromUtf8(DESCRIPTION))
            .setUrl(ByteString.copyFromUtf8(URL)).build());
  ...
  public void assetNameTest() {
    ...
    Any contract = Any.pack(
        AssetIssueContract.newBuilder()
            .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(OWNER_ADDRESS)))
            .setName(ByteString.EMPTY).setTotalSupply(TOTAL_SUPPLY).setVsNum(VS_NUM).setNum(NUM)
    ...
    contract = Any.pack(
        AssetIssueContract.newBuilder()
            ...
            .setVsNum(VS_NUM).setNum(NUM).setStartTime(nowTime)
            .setEndTime(nowTime + 24 * 3600 * 1000)
            .setDescription(ByteString.copyFromUtf8(DESCRIPTION))
            .setUrl(ByteString.copyFromUtf8(URL)).build());
    ...
    blackholeBalance = dbManager.getAccountStore().getSingularity().getBalance();
    try {
      actuator.validate();
      actuator.execute(ret);
      Assert.assertTrue(false);
    ...
    contract = Any.pack(
        AssetIssueContract.newBuilder()
            .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(OWNER_ADDRESS)))
            .setName(ByteString.copyFromUtf8("t e")).setTotalSupply(TOTAL_SUPPLY).setVsNum(VS_NUM)
            .setNum(NUM)
            .setStartTime(nowTime).setEndTime(nowTime + 24 * 3600 * 1000)
            .setDescription(ByteString.copyFromUtf8(DESCRIPTION))
            .setUrl(ByteString.copyFromUtf8(URL)).build());
    ...
    contract = Any.pack(
        AssetIssueContract.newBuilder()
            .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(OWNER_ADDRESS)))
            .setName(ByteString.copyFromUtf8("0")).setTotalSupply(TOTAL_SUPPLY).setVsNum(VS_NUM)
            .setNum(NUM)
            .setStartTime(nowTime).setEndTime(nowTime + 24 * 3600 * 1000)
            .setDescription(ByteString.copyFromUtf8(DESCRIPTION))
            .setUrl(ByteString.copyFromUtf8(URL)).build());
  ...
  public void assetIssueTRXNameTest() {
    ...
    Any contract = Any.pack(
        AssetIssueContract.newBuilder()
            .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(OWNER_ADDRESS)))
            .setName(ByteString.copyFromUtf8("TRX")).setTotalSupply(TOTAL_SUPPLY).setVsNum(VS_NUM)
            .setNum(NUM)
            .setStartTime(startTime).setEndTime(endTime)
            .setDescription(ByteString.copyFromUtf8("description"))
            .setUrl(ByteString.copyFromUtf8(URL)).build());
  ...
  public void IssueSameTokenNameAssert() {
    ...
    AssetIssueContract assetIssueContract = AssetIssueContract.newBuilder()
        ...
        .setTotalSupply(TOTAL_SUPPLY)
        .setVsNum(VS_NUM).setNum(NUM).setStartTime(1).setEndTime(100).setVoteScore(2)
