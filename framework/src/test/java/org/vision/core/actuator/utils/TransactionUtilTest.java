...
public class TransactionUtilTest {
  ...
  public void isNumberCheck() throws UnsupportedEncodingException {
    TransactionUtil actuatorUtil = new TransactionUtil();
    String number = "";
    Assert.assertEquals(false, org.vision.core.capsule.utils.TransactionUtil.isNumber(number.getBytes("utf-8")));
    ...
    Assert.assertEquals(false, org.vision.core.capsule.utils.TransactionUtil.isNumber(number.getBytes("utf-8")));
    number = "24";
    Assert.assertEquals(true, org.vision.core.capsule.utils.TransactionUtil.isNumber(number.getBytes("utf-8")));
  }
