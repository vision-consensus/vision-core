...
public class TransferActuatorTest {
  ...
  public void perfectTransfer() {
    ...
    actuator.setChainBaseManager(dbManager.getChainBaseManager())
        .setAny(getContract(OWNER_BALANCE - Parameter.ChainConstant.TRANSFER_FEE));
  ...
  public void iniviateVs() {
    ...
    try {
      actuator.validate();
      actuator.execute(ret);
      fail("Cannot transfer vs to yourself.");

    } catch (ContractValidateException e) {
      Assert.assertTrue(e instanceof ContractValidateException);
      Assert.assertEquals("Cannot transfer VS to yourself.", e.getMessage());
      AccountCapsule owner = dbManager.getAccountStore()
          .get(ByteArray.fromHexString(OWNER_ADDRESS));
      AccountCapsule toAccount = dbManager.getAccountStore()
          .get(ByteArray.fromHexString(TO_ADDRESS));
  ...
  public void commonErrorCheck() {
    ...
    actuatorTest.setContract(getContract(OWNER_BALANCE - Parameter.ChainConstant.TRANSFER_FEE));
