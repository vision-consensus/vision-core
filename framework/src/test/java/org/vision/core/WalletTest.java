...
import org.vision.protos.Protocol.BlockHeader.raw;
...
public class WalletTest {
  ...
  public void testGetEcKey() {
    ...
    logger.info("wallet address = {}", ByteArray.toHexString(wallet1
        .getAddress()));
    Assert.assertEquals("Wallet ECKey should match provided ECKey", wallet1.getCryptoEngine(), ecKey);
  }
  ...
  public void testChainParameters() {
    ...
    Arrays.stream(ProposalUtil.ProposalType.values()).forEach(parameters -> {
