...
contract KittyBreeding is KittyOwnership {
    ...
    uint256 public autoBirthFee = 2 vdt;
...
contract KittyMinting is KittyAuction {
    ...
    uint256 public constant GEN0_STARTING_PRICE = 10 vdt;
...
contract KittyCore is KittyMinting {
    ...
    function unpause(address payable toAddress, uint256 tokenValue, vrcToken tokenId) public onlyCEO whenPaused returns (uint256 r) {
