...
contract token{
    ...
    function() payable external{}
     function testInCall(address callBAddress,address callCAddress, address toAddress ,uint256 amount,vrcToken id) payable public{
         //callBAddress.call(bytes4(keccak256("transC(address,address,uint256,vrcToken)")),callCAddress,toAddress,amount,id);
...
contract B{
    ...
    function  transC(address payable callCAddress,address payable toAddress,uint256 amount, vrcToken id) payable public{
