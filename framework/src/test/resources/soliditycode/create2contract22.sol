contract Factory {
    event Deployed(address addr, vrcToken salt, address sender);
    ...
    function deploy(bytes memory code, vrcToken salt) public returns(address){
        address addr;
        assembly {
...
contract TestConstract {
    ...
    function testTransferToken(uint256 i,vrcToken tokenId) payable public{
