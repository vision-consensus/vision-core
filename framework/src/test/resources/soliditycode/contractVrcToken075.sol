...
contract Dest {
 ...
 function getToken(vrcToken tokenId) payable public{
 ...
 function getTokenLongMin() payable public{
        // long.min - 1000020
 emit logGetToken(msg.sender.tokenBalance(vrcToken(-9223372036855775828)), msg.tokenid, msg.tokenvalue, msg.value);
 }

 function getTokenLongMax() payable public{
        // long.max + 1000020
 emit logGetToken(msg.sender.tokenBalance(vrcToken(9223372036855775827)), msg.tokenid, msg.tokenvalue, msg.value);
 }
