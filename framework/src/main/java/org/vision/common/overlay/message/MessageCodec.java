...
import org.vision.core.net.message.PbftMessageFactory;
import org.vision.core.net.message.VisionMessageFactory;
...
public class MessageCodec extends ByteToMessageDecoder {
  ...
  private VisionMessageFactory visionMessageFactory = new VisionMessageFactory();
  ...
  private Message createMessage(byte[] encoded) throws Exception {
    ...
    if (MessageTypes.inVisionRange(type)) {
      return visionMessageFactory.create(encoded);
    }
