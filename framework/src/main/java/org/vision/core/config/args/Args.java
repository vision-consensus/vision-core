...
import org.vision.common.args.Account;
...
import org.vision.common.logsfilter.TriggerConfig;
...
import org.vision.core.config.Parameter.NodeConstant;
...
public class Args extends CommonParameter {
  ...
  public static void clearParam() {
    ...
    PARAMETER.allowVvmSolidity059 = 0;
  ...
  public static void setParam(final String[] args, final String confFileName) {
    ...
    PARAMETER.allowVvmTransferVrc10 =
        config.hasPath(Constant.COMMITTEE_ALLOW_VVM_TRANSFER_VRC10) ? config
            .getInt(Constant.COMMITTEE_ALLOW_VVM_TRANSFER_VRC10) : 0;

    PARAMETER.allowVvmConstantinople =
        config.hasPath(Constant.COMMITTEE_ALLOW_VVM_CONSTANTINOPLE) ? config
            .getInt(Constant.COMMITTEE_ALLOW_VVM_CONSTANTINOPLE) : 0;

    PARAMETER.allowVvmSolidity059 =
        config.hasPath(Constant.COMMITTEE_ALLOW_VVM_SOLIDITY059) ? config
            .getInt(Constant.COMMITTEE_ALLOW_VVM_SOLIDITY059) : 0;
    ...
    PARAMETER.allowShieldedVRC20Transaction =
        config.hasPath(Constant.COMMITTEE_ALLOW_SHIELDED_VRC20_TRANSACTION) ? config
            .getInt(Constant.COMMITTEE_ALLOW_SHIELDED_VRC20_TRANSACTION) : 0;
    ...
    PARAMETER.allowVvmIstanbul =
        config.hasPath(Constant.COMMITTEE_ALLOW_VVM_ISTANBUL) ? config
            .getInt(Constant.COMMITTEE_ALLOW_VVM_ISTANBUL) : 0;
    ...
    PARAMETER.allowVvmStake =
            config.hasPath(Constant.COMMITTEE_ALLOW_VVM_STAKE) ? config
                    .getInt(Constant.COMMITTEE_ALLOW_VVM_STAKE) : 0;
    ...
    PARAMETER.spreadMintUnlimitedPledge =
            config.hasPath(Constant.DEBUG_FEATURE_EFFECT_SPREADMINT_UNLIMITEDPLEDGE) ? config
                    .getLong(Constant.DEBUG_FEATURE_EFFECT_SPREADMINT_UNLIMITEDPLEDGE) : 0L;

    PARAMETER.witnessSort =
            config.hasPath(Constant.DEBUG_FEATURE_EFFECT_WITNESS_SORT) ? config
                    .getLong(Constant.DEBUG_FEATURE_EFFECT_WITNESS_SORT) : 0L;
