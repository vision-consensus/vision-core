...
public class FullNodeHttpApiService implements Service {
  ...
  @Autowired
  private UpdateEntropyLimitServlet updateEntropyLimitServlet;
  @Autowired
  ...
  @Autowired
  private GetTriggerInputForShieldedVRC20ContractServlet getTriggerInputForShieldedVRC20ContractServlet;
  @Autowired
  ...
  @Autowired
  private FreezeAccountServlet freezeAccountServlet;

  @Autowired
  private UnfreezeAccountServlet unfreezeAccountServlet;
  ...
  public void start() {
    try {
      ...
      context
          .addServlet(new ServletHolder(isShieldedVRC20ContractNoteSpentServlet),
              "/wallet/isshieldedvrc20contractnotespent");
      ...
      context.addServlet(new ServletHolder(scanShieldedVRC20NotesByIvkServlet),
          "/wallet/scanshieldedvrc20notesbyivk");
      context.addServlet(new ServletHolder(scanShieldedVRC20NotesByOvkServlet),
          "/wallet/scanshieldedvrc20notesbyovk");
      context.addServlet(new ServletHolder(getTriggerInputForShieldedVRC20ContractServlet),
      ...
      context.addServlet(new ServletHolder(freezeAccountServlet), "/wallet/freezeaccount");
      context.addServlet(new ServletHolder(unfreezeAccountServlet), "/wallet/unfreezeaccount");
