...
public class HttpSelfFormatFieldName {
  ...
  static {
    ...
    //PrivateShieldedVRC20Parameters
    AddressFieldNameMap.put(
        "protocol.PrivateShieldedVRC20Parameters.transparent_to_address", 1);
    AddressFieldNameMap.put(
        "protocol.PrivateShieldedVRC20Parameters.shielded_VRC20_contract_address", 1);
    //PrivateShieldedVRC20ParametersWithoutAsk
    AddressFieldNameMap.put(
        "protocol.PrivateShieldedVRC20ParametersWithoutAsk.transparent_to_address", 1);
    AddressFieldNameMap.put(
        "protocol.PrivateShieldedVRC20ParametersWithoutAsk.shielded_VRC20_contract_address", 1);
    //IvkDecryptVRC20Parameters
    AddressFieldNameMap.put(
        "protocol.IvkDecryptVRC20Parameters.shielded_VRC20_contract_address", 1);
    //OvkDecryptVRC20Parameters
    AddressFieldNameMap.put(
        "protocol.OvkDecryptVRC20Parameters.shielded_VRC20_contract_address", 1);
    //NfVRC20Parameters
    AddressFieldNameMap.put(
        "protocol.NfVRC20Parameters.shielded_VRC20_contract_address", 1);
    //ShieldedVRC20TriggerContractParameters
    AddressFieldNameMap.put(
        "protocol.ShieldedVRC20TriggerContractParameters.transparent_to_address", 1);
    AddressFieldNameMap.put(
        "protocol.DecryptNotesVRC20.NoteTx.transparent_to_address", 1);
