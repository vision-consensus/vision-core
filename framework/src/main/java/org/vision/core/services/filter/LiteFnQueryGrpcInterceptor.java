...
public class LiteFnQueryGrpcInterceptor implements ServerInterceptor {
  ...
  static {
    ...
    filterMethods.add("protocol.Wallet/ScanShieldedVRC20NotesByIvk");
    filterMethods.add("protocol.Wallet/ScanShieldedVRC20NotesByOvk");
    filterMethods.add("protocol.Wallet/IsShieldedVRC20ContractNoteSpent");
    ...
    filterMethods.add("protocol.WalletSolidity/ScanShieldedVRC20NotesByIvk");
    filterMethods.add("protocol.WalletSolidity/ScanShieldedVRC20NotesByOvk");
    filterMethods.add("protocol.WalletSolidity/IsShieldedVRC20ContractNoteSpent");
