...
public class LiteFnQueryHttpFilter implements Filter {
  ...
  static {
    ...
    filterPaths.add("/wallet/scanshieldedvrc20notesbyivk");
    filterPaths.add("/wallet/scanshieldedvrc20notesbyovk");
    filterPaths.add("/wallet/isshieldedvrc20contractnotespent");
    ...
    filterPaths.add("/walletsolidity/scanshieldedvrc20notesbyivk");
    filterPaths.add("/walletsolidity/scanshieldedvrc20notesbyovk");
    filterPaths.add("/walletsolidity/isshieldedvrc20contractnotespent");
    ...
    filterPaths.add("/walletpbft/scanshieldedvrc20notesbyivk");
    filterPaths.add("/walletpbft/scanshieldedvrc20notesbyovk");
    filterPaths.add("/walletpbft/isshieldedvrc20contractnotespent");
  }
