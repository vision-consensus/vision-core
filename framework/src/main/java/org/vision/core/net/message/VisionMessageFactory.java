...
import org.vision.common.overlay.message.MessageFactory;
import org.vision.core.exception.P2pException;

/**
 * msg factory.
 */
public class VisionMessageFactory extends MessageFactory {

  private static final String DATA_LEN = ", len=";

  @Override
  public VisionMessage create(byte[] data) throws Exception {
  ...
  private VisionMessage create(byte type, byte[] packed) throws Exception {
