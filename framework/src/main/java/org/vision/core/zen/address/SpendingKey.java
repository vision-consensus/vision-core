...
import org.vision.common.zksnark.JLibsodiumParam.Blake2bFinalParams;
import org.vision.common.zksnark.JLibsodiumParam.Blake2bInitSaltPersonalParams;
import org.vision.common.zksnark.JLibsodiumParam.Blake2bUpdateParams;
      ...
      try {
        JLibsodium.cryptoGenerichashBlake2bInitSaltPersonal(
            new Blake2bInitSaltPersonalParams(state, null, 0, 64, null,
                Constant.ZVISION_EXPANDSEED_PERSONALIZATION));
