package org.vision.core.zen.note;

import static org.vision.common.zksnark.JLibsodium.CRYPTO_AEAD_CHACHA20POLY1305_IETF_NPUBBYTES;
import static org.vision.core.utils.ZenChainParams.ZC_ENCCIPHERTEXT_SIZE;
import static org.vision.core.utils.ZenChainParams.ZC_ENCPLAINTEXT_SIZE;
...
import org.vision.common.zksnark.JLibsodiumParam.Black2bSaltPersonalParams;
import org.vision.common.zksnark.JLibsodiumParam.Chacha20Poly1305IetfEncryptParams;
import org.vision.common.zksnark.JLibsodiumParam.Chacha20poly1305IetfDecryptParams;
import org.vision.common.zksnark.LibrustzcashParam.KaAgreeParams;
import org.vision.common.zksnark.LibrustzcashParam.KaDerivepublicParams;
import org.vision.core.exception.ZksnarkException;
import org.vision.core.utils.ZenChainParams;
import org.vision.core.zen.note.NoteEncryption.Encryption.EncCiphertext;
