...
public class Constant {
  ...
  public static final byte ADD_PRE_FIX_BYTE_MAINNET = (byte) 0x46;   //46 + address
  ...
  public static final String COMMITTEE_ALLOW_VVM_TRANSFER_VRC10 = "committee.allowVvmTransferVrc10";

  public static final String COMMITTEE_ALLOW_VVM_CONSTANTINOPLE = "committee.allowVvmConstantinople";

  public static final String COMMITTEE_ALLOW_VVM_SOLIDITY059 = "committee.allowVvmSolidity059";
  ...
  public static final String COMMITTEE_ALLOW_SHIELDED_VRC20_TRANSACTION = "committee"
      + ".allowShieldedVRC20Transaction";

  public static final String COMMITTEE_ALLOW_VVM_ISTANBUL = "committee"
      + ".allowVvmIstanbul";
  ...
  public static final String COMMITTEE_ALLOW_VVM_STAKE = "committee.allowVvmStake";
  ...
  public static final String ETH_JSON_RPC_FILTER_ENABLED = "eth.jsonRpcFilterEnabled";
